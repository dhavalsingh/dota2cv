// iniciar variables
var buildings = ['pl', 'invo', 'enigma', 'spec'];
...
/*             var talk_random = Math.floor(Math.random() * 2);
    ...
    // terreno aleatorio
    var lands_images = ['background.jpg'];



        lands_images.push('background.jpg');
...
function startWalking() {
 ...
 /*    if (music_start == false) {
    ...
    //  rotate villager if moving left or right
